    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<OpeningEntity, Opening>()
                ...
                .ForMember(dest => dest.StartAt, opt => opt.MapFrom(src => src.StartAt.Value.UtcDateTime))
                .ForMember(dest => dest.EndAt, opt => opt.MapFrom(src => src.EndAt.Value.UtcDateTime))
