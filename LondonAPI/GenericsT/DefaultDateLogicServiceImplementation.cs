...
{
    public class DefaultDateLogicServiceImplementation(IOptions<HotelOptions> optionsAccessor) : IDateLogicService
    {
        private readonly HotelOptions _hotelOptions = optionsAccessor.Value;
